...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2022 at 02:18 AM
...
--
-- Database: `db_akademik_0486`
--

-- --------------------------------------------------------

--
-- Table structure for table `tbl_students_0486`
--

CREATE TABLE `tbl_students_0486` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0486`
--

INSERT INTO `tbl_students_0486` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0486`
--
ALTER TABLE `tbl_students_0486`
  ADD PRIMARY KEY (`id`);
COMMIT;
